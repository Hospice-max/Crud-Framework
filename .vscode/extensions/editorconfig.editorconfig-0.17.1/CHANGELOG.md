...
- **Revert:** The cursor position changes if it was on the last character of the last line when the final newline was inserted. This is an expected regression that will be fixed in the next version after the VSCode update
