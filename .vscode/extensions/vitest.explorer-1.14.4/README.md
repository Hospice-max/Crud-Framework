<p align="center">
  <a title="Learn more about Vitest extension for Visual Studio Code" href="https://github.com/vitest-dev/vscode"><img src="https://github.com/vitest-dev/vscode/raw/HEAD/img/cover.png" alt="Vitest extension for Visual Studio Code logo" width="50%" /></a>
</p>
...
- NX support (see the [NX sample](https://github.com/vitest-dev/vscode/blob/HEAD/samples/monorepo-nx/)).
